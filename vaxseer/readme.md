...
Training typically takes about 8 minutes per epoch for ~20k sequences on a single NVIDIA RTX A6000 GPU.
...
Training typically takes about 10 minutes per epoch on a single NVIDIA RTX A6000 GPU.
