...
class MSATransformer(nn.Module):
    ...
    def forward(self, tokens, repr_layers=[], need_head_weights=False, return_contacts=False, token_embeddings=None, extra_input_embeddings=None):
        if return_contacts:
