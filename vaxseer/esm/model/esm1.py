...
class ProteinBertModel(nn.Module):
    ...
    def __init__(self, args, alphabet):
        ...
        self.output_alphabet_size = getattr(args, "output_alphabet_size", self.alphabet_size)
    ...
    def _init_submodules_esm1b(self):
        ...
        self.lm_head = RobertaLMHead(
            ...
            output_dim=self.output_alphabet_size,
    ...
    def _init_submodules_esm1(self):
        ...
        self.embed_out = nn.Parameter(torch.zeros((self.output_alphabet_size, self.args.embed_dim)))
        self.embed_out_bias = None
        if self.args.final_bias:
            self.embed_out_bias = nn.Parameter(torch.zeros(self.output_alphabet_size))

    def forward(self, tokens, repr_layers=[], need_head_weights=False, return_contacts=False, inputs_embeds = None):
        if return_contacts:
