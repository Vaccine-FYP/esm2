...
do
    ...
    do
        ...
        working_directory="../runs/pipeline_qwen2/"$year"-"$month"/$subtype/vaccine_set=who___virus_set=$three_years_before-"$month"-$year-"$month""
