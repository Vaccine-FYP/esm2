...
lm_ckpt=$(ls $ckpt_root_dir/flu_lm/2003-10_to_"$year"-"$month"_2M/$subtype/human_minBinSize100_lenQuantile0.2/weight_loss_by_count/lightning_logs/version_0/checkpoints/epoch=*-step=*.ckpt) 
